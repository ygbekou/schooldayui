...
export class StateService {
  ...
  private baseUrlRest = Constants.apiServer + "/service/immobilisation/state"
  ...
  public save = (item: State): Observable<State> => {
  ...
  public delete = (file: State): Observable<Boolean> => {
