...
export class VendorService {
  ...
  private baseUrlRest = Constants.apiServer + "/service/immobilisation/vendor"
  ...
  public getAll = (): Observable<Vendor[]> => {
    ...
    return this.http.get(this.actionUrl)
      .map((response: Response) => <Vendor[]>response.json())
      .catch(this.handleError);
}

  public save = (item: Vendor): Observable<Vendor> => {
  ...
  public delete = (file: Vendor): Observable<Boolean> => {
