...
export class PlaceService {
  ...
  private baseUrlRest = Constants.apiServer + "/service/immobilisation/place"
  ...
  public save = (item: Place): Observable<Place> => {
  ...
  public delete = (file: Place): Observable<Boolean> => {
