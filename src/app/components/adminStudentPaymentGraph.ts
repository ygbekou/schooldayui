...
@Component({
  selector: 'app-admin-student-payment-graph',
  templateUrl: '../pages/adminStudentPaymentGraph.html',
  providers: [SchoolYearDropdown]
})
export class AdminStudentPaymentGraph implements OnInit {
  data: any;
  ...
  public getPaymentGraphForCurrentSchoolYear() {
