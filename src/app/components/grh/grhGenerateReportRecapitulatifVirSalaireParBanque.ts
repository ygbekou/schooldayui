...
@Component({
  selector: 'app-grh-generate-report-recapitulatif-vir-salaire-banque',
  templateUrl: '../../pages/grh/grhGenerateReportRecapitulatifVirSalaireParBanque.html',
  providers: [EmployeeService, Constants]
})

export class GrhGenerateReportRecapitulatifVirSalaireParBanque implements OnInit, OnDestroy {
  ...
  public printRecapitulatifVirementSalaireParBanque() {
    this.reportName=null;
    this.printLabel=Constants.GENERATION_ETAT;

    this.employeeService.printRecapitulatifVirementSalaireParBanque(this.paySlip.periode)
    .subscribe((data: string) => {
      this.reportName = data;
      this.printLabel=Constants.GENERER_ETAT;
    },
    error => console.log(error),
    () => console.log('Print RecapitulatifGlobalVirementSalaireParBanque complete'));
  }
