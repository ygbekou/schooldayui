...
@Component({
  selector: 'app-grh-generate-report-honoraire-teacher-types',
  templateUrl: '../../pages/grh/grhGenerateReportHonoraireTeacherTypes.html',
  providers: [EmployeeService, Constants]
})

export class GrhGenerateReportHonoraireTeacherTypes implements OnInit, OnDestroy {
  ...
  public printEtatHonoraiePeriodTypeTeachers() {
    this.reportName=null;
    ...
    this.employeeService.printEtatHonoraiePeriodTypeTeachers(this.paySlip)
    .subscribe((data: string) => {
      this.reportName = data;
      this.printLabel=Constants.GENERER_ETAT;
    },
    error => console.log(error),
    () => console.log('Print EtatHonoraiePeriodAllTeachers complete'));
  }
