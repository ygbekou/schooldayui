...
@Component({
  selector: 'app-grh-generate-report-honoraires-one-teacher',
  templateUrl: '../../pages/grh/grhGenerateReportHonorairesOneTeacher.html',
  providers: [PaySlipService, EmployeeService, Constants]
})

export class GrhGenerateReportHonorairesOneTeacher implements OnInit, OnDestroy {
 ...
 public initParameters() {
  ...
  public printEtatHonoraiePeriodTeacher() {
    this.reportName=null;
    //this.paySlip.employee = this.employee;
    this.printLabel=Constants.GENERATION_ETAT;

    this.employeeService.printEtatHonoraiePeriodTeacher(this.paySlip)
