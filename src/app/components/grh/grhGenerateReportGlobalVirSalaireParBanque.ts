...
@Component({
  selector: 'app-grh-generate-report-global-vir-salaire-banque',
  templateUrl: '../../pages/grh/grhGenerateReportGlobalVirSalaireParBanque.html',
  providers: [EmployeeService, Constants]
})

export class GrhGenerateReportGlobalVirSalaireParBanque implements OnInit, OnDestroy {
  ...
  public printRecapitulatifGlobalVirementSalaireParBanque() {
    this.reportName=null;
    this.printLabel=Constants.GENERATION_ETAT;

    this.employeeService.printRecapitulatifGlobalVirementSalaireParBanque(this.paySlip.periode)
