...
import { ConfirmationService, DataTableModule, DialogModule, Message, MessageService } from 'primeng/primeng';
import { StudentView } from 'app/models/studentView';
import {ToggleButtonModule} from 'primeng/togglebutton';
import { AttendanceDetails } from 'app/models/attendanceDetails';
@Component({
  selector: 'app-manage-attendance',
  templateUrl: '../pages/manageAttendance.html',
  providers: [TimeSheetService, SubjectService, LookUpTableService, Constants,CourseService,ConfirmationService, MessageService]
})

export class ManageAttendance implements OnInit, OnDestroy {
  ...
  saveAttendanceDetail(at : AttendanceDetails){
   this.attendanceDetail = at;
   this.attendanceDetail.parContact = at.parContact;
  ...
  confirm() {
    this.confirmationService.confirm({
        header: 'Veuillez confirmer l\'appel',
        message: 'Êtes-vous sûr(e) de vouloir valider cet appel ?',
