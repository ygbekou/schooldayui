...
@Component({
  selector: 'app-admin-calc-year',
  templateUrl: '../pages/adminCalcYear.html',
  providers: [ExamService, Constants, ClassDropdown, SchoolYearDropdown, TermDropdown]
})
export class AdminCalcYear implements OnInit, OnDestroy {
  ...
  QUATERLY_REPORTS: string = Constants.QUATERLY_REPORTS;
  ...
  public calculate() {
    ...
    if (this.selectedClasse != null && this.selectedSchoolYear != null) {

      this.examService.calculateYear(this.selectedClasse.id + "," + this.selectedSchoolYear.id + "," + this.user.id).subscribe((data: string) => {
        if (data == "Success") {
  ...
  public getResults() {
    ...
    if (this.selectedClasse != null
      ...
      this.examService.getYearResults(this.selectedClasse.id
  ...
  public getBulletins(resultSummary: ResultSummaryView) {
    this.msg = null;
    this.error = null;
    this.resultSummary = resultSummary;
    this.examService.getYearBulletins(resultSummary)
  ...
  public emailResults() {
    ...
    if (this.selectedClasse != null
      && this.selectedSchoolYear != null) {
      this.examService.emailYearResults(this.selectedClasse.id
        + "," + this.selectedSchoolYear.id
