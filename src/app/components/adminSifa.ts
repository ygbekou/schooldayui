...
import { OnlineRegistration } from 'app/models/onlineRegistration';
@Component({
  selector: 'app-admin-sifa',
  templateUrl: '../pages/adminSifa.html',
  providers: [LevelDropdown]
})
export class AdminSifa implements OnInit, OnDestroy {
  ...
  public getAll(): void {
    this.users = [];
    this.userService.loadAllBourseSifaUsers()
      .subscribe((data: User[]) => {
        this.users = data;
