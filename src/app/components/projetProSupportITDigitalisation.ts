...
@Component({
    moduleId: 'module.id',
    selector: 'app-projets-supportIT-dig',
    templateUrl:'../pages/projetProSupportITDigitalisation.html',
    providers: [StudentProjectService]
})

export class ProjetProSupportITDigitalisation implements OnInit, AfterViewInit{
    ...
    public getSupporITProject() {
        this.studentProjectService.getSupporITProject().subscribe((data: StudentProjectCategory[]) => {
                this.themes = data;
            },
