...
@Component({
  selector: 'app-secretaire-student-project',
  templateUrl: '../../pages/secretaire/secretaireStudentProject.html'
})
export class SecretaireStudentProject implements OnInit {
